...
class _DailyQuestionScreenState extends State<DailyQuestionScreen>
  ...
  static final List<_QuestionItem> _questionBank = [
    // --- 自我认知 (10) ---
    _QuestionItem('如果今天是你生命中最重要的一天，你会怎么度过？', '自我认知'),
    _QuestionItem('你最近学到的最重要的一课是什么？', '自我认知'),
    _QuestionItem('如果用三个词形容现在的自己，你会选什么？', '自我认知'),
    _QuestionItem('你内心深处最害怕的是什么？你如何面对它？', '自我认知'),
    _QuestionItem('什么事情让你觉得"这就是我"？', '自我认知'),
    _QuestionItem('如果可以改变自己的一件事，你会改变什么？', '自我认知'),
    _QuestionItem('你觉得自己最被低估的优点是什么？', '自我认知'),
    _QuestionItem('上一次你为自己感到骄傲是什么时候？', '自我认知'),
    _QuestionItem('有什么事情是你一直想做但还没开始的？', '自我认知'),
    _QuestionItem('你觉得十年后的自己会对现在的你说什么？', '自我认知'),

    // --- 人际关系 (10) ---
    _QuestionItem('谁是你生命中意想不到的贵人？', '人际关系'),
    _QuestionItem('最近一次让你真心笑出声的事是什么？', '人际关系'),
    _QuestionItem('你最想对谁说一声"谢谢"？为什么？', '人际关系'),
    _QuestionItem('有没有一个人，改变了你的人生轨迹？', '人际关系'),
    _QuestionItem('你觉得自己在别人眼中是什么样的人？', '人际关系'),
    _QuestionItem('最近一次和朋友深入交流是什么时候？', '人际关系'),
    _QuestionItem('你如何处理与他人的冲突和误解？', '人际关系'),
    _QuestionItem('有没有一个人，你想重新联系但一直没勇气？', '人际关系'),
    _QuestionItem('你觉得爱和被爱，哪个更重要？', '人际关系'),
    _QuestionItem('如果可以请任何人共进晚餐，你会选谁？', '人际关系'),

    // --- 未来展望 (10) ---
    _QuestionItem('如果可以对10年前的自己说一句话，你会说什么？', '未来展望'),
    _QuestionItem('你对未来最大的期待是什么？', '未来展望'),
    _QuestionItem('如果可以拥有一种超能力，你希望是什么？', '未来展望'),
    _QuestionItem('你理想中的一天是怎样的？', '未来展望'),
    _QuestionItem('如果不考虑现实限制，你最想做什么工作？', '未来展望'),
    _QuestionItem('你想给这个世界留下什么？', '未来展望'),
    _QuestionItem('明年今天，你希望自己有什么不同？', '未来展望'),
    _QuestionItem('你最大的梦想还在吗？它是否改变了？', '未来展望'),
    _QuestionItem('如果可以选择在任何地方生活，你会选哪里？', '未来展望'),
    _QuestionItem('你希望自己的墓志铭上写什么？', '未来展望'),

    // --- 过往回顾 (10) ---
    _QuestionItem('童年最温暖的记忆是什么？', '过往回顾'),
    _QuestionItem('有没有一件事让你至今后悔？', '过往回顾'),
    _QuestionItem('你人生中的转折点是什么？', '过往回顾'),
    _QuestionItem('上一次哭是因为什么？', '过往回顾'),
    _QuestionItem('你做过最勇敢的一件事是什么？', '过往回顾'),
    _QuestionItem('有没有一个决定改变了你的人生？', '过往回顾'),
    _QuestionItem('你最大的失败教会了你什么？', '过往回顾'),
    _QuestionItem('如果有人给你一笔巨款，你会用它做什么？', '过往回顾'),
    _QuestionItem('你人生中最难忘的一次旅行是？', '过往回顾'),
    _QuestionItem('如果可以重新活一天，你会选哪一天？', '过往回顾'),

    // --- 假设想象 (10) ---
    _QuestionItem('如果明天是世界末日，你会如何度过最后一天？', '假设想象'),
    _QuestionItem('如果你可以隐身一天，你会做什么？', '假设想象'),
    _QuestionItem('如果你能和任何历史人物对话，你想和谁聊什么？', '假设想象'),
    _QuestionItem('如果你的生活是一部电影，它的名字是什么？', '假设想象'),
    _QuestionItem('如果你变成了动物，你觉得自己会是什么？', '假设想象'),
    _QuestionItem('如果能发明一样东西，你会发明什么？', '假设想象'),
    _QuestionItem('如果你有一台时光机，你会回到过去还是去往未来？', '假设想象'),
    _QuestionItem('如果幸福可以充值，你愿意用什么来交换？', '假设想象'),
    _QuestionItem('如果你只能保留一个记忆，你会保留什么？', '假设想象'),
    _QuestionItem('如果一个陌生人可以了解你的一件事，你希望是什么？', '假设想象'),
  ];
